MemoryAligned16 = function MemoryAligned16(size) {
	this.buffer = new Uint16Array(size >> 1);
};

MemoryAligned16.prototype.freeze = function () {
	return _.cloneDeep(this.buffer);
};

MemoryAligned16.prototype.defrost = function (frost) {
	this.buffer = frost;
};
...
GameBoyAdvanceVRAM = function GameBoyAdvanceVRAM(size) {
...
GameBoyAdvanceOAM = function GameBoyAdvanceOAM(size) {
	MemoryAligned16.call(this, size);
...
GameBoyAdvancePalette = function GameBoyAdvancePalette() {
...
GameBoyAdvancePalette.prototype.freeze = function () {
	return {
		colors: _.cloneDeep(this.colors),
		adjustedColors: _.cloneDeep(this.adjustedColors),
		passthroughColors: _.cloneDeep(this.passthroughColors),
		blendY: _.cloneDeep(this.blendY),
	};
};
...
GameBoyAdvanceOBJ = function GameBoyAdvanceOBJ(oam, index) {
...
GameBoyAdvanceOBJLayer = function GameBoyAdvanceOBJLayer(video, index) {
	this.video = video;
	this.bg = false;
...
GameBoyAdvanceSoftwareRenderer = function GameBoyAdvanceSoftwareRenderer() {
	this.LAYER_BG0 = 0;
	this.LAYER_BG1 = 1;
	this.LAYER_BG2 = 2;
	this.LAYER_BG3 = 3;
...
function getPrimitiveProperties(obj) {
	return Object.keys(obj).reduce((building, prop) => {
...
function restorePrimitiveProperties(obj, primitives) {
...
GameBoyAdvanceSoftwareRenderer.prototype.freeze = function (encodeBase64) {
	...
	const state = {
		...
		oam: this.oam.freeze(),
		windows: _.cloneDeep(this.windows),
		target1: _.cloneDeep(this.target1),
		target2: _.cloneDeep(this.target2),
		scanline: _.cloneDeep(this.scanline),
		sharedColor: _.cloneDeep(this.sharedColor),
		sharedMap: _.cloneDeep(this.sharedMap),
		bg: this.freezeBg(),
