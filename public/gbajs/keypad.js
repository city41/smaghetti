GameBoyAdvanceKeypad = function GameBoyAdvanceKeypad() {
	window.GBA_KEYCODE_LEFT =
		typeof window.GBA_KEYCODE_LEFT === 'number' ? window.GBA_KEYCODE_LEFT : 37;
	window.GBA_KEYCODE_UP =
		typeof window.GBA_KEYCODE_UP === 'number' ? window.GBA_KEYCODE_UP : 38;
	window.GBA_KEYCODE_RIGHT =
		typeof window.GBA_KEYCODE_RIGHT === 'number'
			? window.GBA_KEYCODE_RIGHT
			: 39;
	window.GBA_KEYCODE_DOWN =
		typeof window.GBA_KEYCODE_DOWN === 'number' ? window.GBA_KEYCODE_DOWN : 40;
	window.GBA_KEYCODE_START =
		typeof window.GBA_KEYCODE_START === 'number'
			? window.GBA_KEYCODE_START
			: 13;
	window.GBA_KEYCODE_SELECT =
		typeof window.GBA_KEYCODE_SELECT === 'number'
			? window.GBA_KEYCODE_SELECT
			: 220;
	window.GBA_KEYCODE_A =
		typeof window.GBA_KEYCODE_A === 'number' ? window.GBA_KEYCODE_A : 88;
	window.GBA_KEYCODE_B =
		typeof window.GBA_KEYCODE_B === 'number' ? window.GBA_KEYCODE_B : 90;
	window.GBA_KEYCODE_L =
		typeof window.GBA_KEYCODE_L === 'number' ? window.GBA_KEYCODE_L : 65;
	window.GBA_KEYCODE_R =
		typeof window.GBA_KEYCODE_R === 'number' ? window.GBA_KEYCODE_R : 83;

	window.GBA_GAMEPAD_LEFT =
		typeof window.GBA_GAMEPAD_LEFT === 'number' ? window.GBA_GAMEPAD_LEFT : 14;
	window.GBA_GAMEPAD_UP =
		typeof window.GBA_GAMEPAD_UP === 'number' ? window.GBA_GAMEPAD_UP : 12;
	window.GBA_GAMEPAD_RIGHT =
		typeof window.GBA_GAMEPAD_RIGHT === 'number'
			? window.GBA_GAMEPAD_RIGHT
			: 15;
	window.GBA_GAMEPAD_DOWN =
		typeof window.GBA_GAMEPAD_DOWN === 'number' ? window.GBA_GAMEPAD_DOWN : 13;
	window.GBA_GAMEPAD_START =
		typeof window.GBA_GAMEPAD_START === 'number' ? window.GBA_GAMEPAD_START : 9;
	window.GBA_GAMEPAD_SELECT =
		typeof window.GBA_GAMEPAD_SELECT === 'number'
			? window.GBA_GAMEPAD_SELECT
			: 8;
	window.GBA_GAMEPAD_A =
		typeof window.GBA_GAMEPAD_A === 'number' ? window.GBA_GAMEPAD_A : 0; // A on an XB1 controller
	window.GBA_GAMEPAD_B =
		typeof window.GBA_GAMEPAD_B === 'number' ? window.GBA_GAMEPAD_B : 2; // X on an XB1 controller
	window.GBA_GAMEPAD_L =
		typeof window.GBA_GAMEPAD_L === 'number' ? window.GBA_GAMEPAD_L : 4;
	window.GBA_GAMEPAD_R =
		typeof window.GBA_GAMEPAD_R === 'number' ? window.GBA_GAMEPAD_R : 5;
