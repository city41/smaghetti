...
const WoodRampDownRight: Entity = {
	paletteCategory: 'terrain',
	paletteInfo: {
		subCategory: 'terrain-basic',
		title: 'Wood Ramp - Down Right',
	},
	...
	resources: {
		WoodRampDownRightBottom: {
			...
			tiles: [
				...
				[0, { tileIndex: 26, flip: 'h' }],
			],
		},
		WoodRampDownRightTop: {
			palettes: [
				[
					0x7ffb,
					0x7fff,
			...
			if (l % 2 === 1) {
				cells.push(
					<div
						...
						className="absolute WoodRampDownRightBottom-bg bg-cover"
					/>
				);
				curX += 1;
			} else {
				cells.push(
					<div
						...
						className="absolute WoodRampDownRightTop-bg bg-cover"
					/>
				);
				curY += 1;
			}
