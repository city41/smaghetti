...
const PiranhaPlantRedFacingLeftFire: Entity = {
	...
	render() {
		...
		return (
			<div
				className="relative PiranhaPlantRedFacingLeftFire-bg bg-center bg-no-repeat"
				style={style}
			>
...
export { PiranhaPlantRedFacingLeftFire };
