...
const PiranhaPlantFire: Entity = {
	paletteCategory: 'enemy',
	paletteInfo: {
		subCategory: 'enemy-piranha',
		title: 'Piranha Plant - Fire',
	},
	...
	simpleRender(size) {
		return (
			<div
				className="PiranhaPlantFire-bg bg-center bg-no-repeat"
	...
	render() {
		...
		return (
			<div className="relative PiranhaPlantFire-bg bg-cover" style={style}>
