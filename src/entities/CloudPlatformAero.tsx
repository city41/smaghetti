...
function isPlatformToLeft(
	...
	return cellToLeft.type === 'CloudPlatformAero';
}
...
function isPlatformToRight(
	...
	return cellToRight.type === 'CloudPlatformAero';
}

const CloudPlatformAero: Entity = {
	paletteCategory: 'terrain',
	paletteInfo: {
		subCategory: 'terrain-sky',
		title: 'Cloud Platform - Aero',
	},
	...
	simpleRender(size) {
		return (
			<div
				className="CloudPlatformAero-bg bg-center bg-no-repeat"
	...
	render(_showDetails, _settings, _onSettingsChange, entity, room) {
		...
		return <div style={style} className="CloudPlatformAero-bg" />;
	},
};

export { CloudPlatformAero };
