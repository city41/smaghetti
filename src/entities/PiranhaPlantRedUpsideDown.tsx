...
const PiranhaPlantRedUpsideDown: Entity = {
	paletteCategory: 'enemy',
	paletteInfo: {
		subCategory: 'enemy-piranha',
		title: 'Piranha Plant - Upside Down Red',
	},
	...
	resource: {
		...
		tiles: [
			...
			[
				{ tileIndex: 992, flip: 'v' },
				{ tileIndex: 992, flip: 'hv' },
			],
		],
	},
	...
	simpleRender(size) {
		...
		return (
			<div
				className="PiranhaPlantRedUpsideDown-bg bg-center bg-no-repeat"
				style={style}
			/>
		);
	},
	...
	render() {
		...
		return (
			<div
				className="relative PiranhaPlantRedUpsideDown-bg bg-no-repeat"
				style={style}
			>
...
export { PiranhaPlantRedUpsideDown };
