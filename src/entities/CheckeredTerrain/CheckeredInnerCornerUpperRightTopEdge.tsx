...
const CheckeredInnerCornerUpperRightTopEdge: Entity = {
	paletteCategory: 'terrain',
	paletteInfo: {
		subCategory: 'terrain-checkered',
		title: 'Checkered Inner Corner - Upper Right, Top Edge',
	},
	...
	simpleRender(size) {
		return (
			<div
				className="CheckeredInnerCornerUpperRightTopEdge-bg bg-cover"
...
export { CheckeredInnerCornerUpperRightTopEdge };
