...
const BowserFireGenerator2: Entity = {
	paletteInfo: {
		title: 'Bowser Fire Generator - Alt',
		description:
			"An alternate fire generator that seems to start right away as long as it is placed with 15 tiles of Mario's starting position in a room.",
	},
