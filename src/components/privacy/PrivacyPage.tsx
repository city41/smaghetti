...
function PrivacyPage() {
	return (
		<Root title="Privacy Policy" metaDescription="">
			<div
			...
			>
				...
				<p>
					...
					<a href="/tos">Terms of Service</a> and this Privacy Policy carefully
					as you must agree to both documents in order to be permitted to use
					our Service.
				</p>

				<h2>Definitions</h2>
				<p>
					Throughout this document, we may use certain words or phrases, and it
					is important that you understand the meaning of them. The following is
					a non-exhaustive list of definitions of words and phrases found in
					this document:
				</p>
				<ul>
					<li>
						“Smaghetti” refers to our company, known as “City41 LLC”; our Site;
						our Service; or a combination of all or some of the preceding
					...
					<li>
						...
						including our game creation, playing and community services and our
						Site itself;
					</li>
					<li>“Site” refers to our website, smaghetti.com;</li>
					<li>
						“User” refers to anyone who uses our Service, including members and
						general visitors to our Site;
					</li>
					<li>
						“You” refers to you, the person who is governed by this Privacy
						Policy.
					</li>
				</ul>
				...
				<p>
					...
					information from you, such as your IP address, referring URL, browser,
				...
				<h2> Cookies</h2>
				<p>
					We use cookies to remember your preferences. For this reason, it is
					necessary that you enable cookies in your browser, and you hereby
					acknowledge that we have informed you of our use of cookies and that
					you consent to our use of cookies in relation to your computer system.
				</p>

				<h2> Third Party Websites</h2>
				<p>
					Smaghetti or its Users may post links to third party websites on our
					Site. These third party websites are not screened for privacy or
					security issues by Smaghetti, and you release us from any liability
				...
				<p>
					...
					enforceable by third parties or require disclosure of any personal
					information relating to members of the Service or Site. Smaghetti
					bears no responsibility for the information collected or used by any
					advertiser or third party website. Please review the privacy policy
				...
				<p>
					Although you are entering into an Agreement with Smaghetti to disclose
					your information to us, we do use third party individuals and
					organizations to assist us, including contractors, web hosts, and
					others.
				</p>
				<p>
					Throughout the course of our provision of our Service to you, we may
					...
					provide us, and we may hire outside contractors to perform maintenance
					or assist us in securing our website.
				</p>
				<p>
					It is therefore necessary that you grant the third parties we may use
					in the course of our business the same rights that you afford us under
					this Privacy Policy. For this reason, you hereby agree that for every
					...
					other actionable wrong against you.
				</p>

				<h2>Release of Your Information for Legal Purposes</h2>
				<p>
					At times it may become necessary or desirable to Smaghetti, for legal
					...
					disclose your information to a third party where we believe, in good
					faith, that it is desirable to do so for the purposes of a civil
					action, criminal investigation, or other legal matter. In the event
					that we receive a subpoena affecting your privacy, we may elect to
					notify you to give you an opportunity to file a motion to quash the
					subpoena, or we may attempt to quash it ourselves, but we are not
					obligated to do either. We may also proactively report you, and
					release your information to, third parties where we believe that it is
					prudent to do so for legal reasons, such as our belief that you have
					engaged in fraudulent activities. You release us from any damages that
					may arise from or relate to the release of your information to a
				...
				<p>
					...
					Service, including using SSL certificates and vulnerability scanning.
					However, we make no representations as to the security or privacy of
					your information. It is in our interest to keep our website secure,
					but we recommend that you use anti-virus software, firewalls, and
					other precautions to protect yourself from security threats.
				</p>

				<h2> Your California Online Privacy Rights</h2>
				<p>
					Smaghetti permits residents of California to use its services.
					Therefore, it is the intent of Smaghetti to comply with the California
					Business and Professions Code §§ 22575-22579. If you are a California
					resident you may request certain information regarding our disclosure
					of personal information to any third parties for their direct
					marketing purposes. Various provisions throughout this Privacy Policy
					address requirements of the Californian privacy statutes. In summary,
					you must presume that we collect electronic information from all
					visitors. You may contact us at matt.e.greer@gmail.com with any
					questions.
				</p>
				...
				<p>
					...
					choose to provide information to us, Smaghetti transfers Personal
					Information to the United States and processes it there. Your consent
