		...
		>
			<div className="max-w-2xl mx-auto pt-16">
				...
				<NewEntry title="Water Current" date="2022-07-04">
					...
					<p>Thanks to Bryce and Bxzr for finding this one</p>
				</NewEntry>
				...
				<NewEntry title="New Entities" date="2022-06-05">
					...
					<p>The trap door that closes Mario in a room with Boom Boom</p>
				</NewEntry>
				...
				<NewEntry title="Entity Search" date="2022-03-31">
					<p>
						...
						the item chooser is open then type in a search term.
					</p>
				</NewEntry>
				<NewEntry
				...
				<NewEntry title="New Entities" date="2022-02-20">
					<ul>
						<li>Bill Blaster - Missile</li>
					</ul>
				</NewEntry>
				<NewEntry
