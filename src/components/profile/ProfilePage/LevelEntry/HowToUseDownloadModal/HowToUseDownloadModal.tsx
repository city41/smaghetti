		...
		>
			<div className={typographyStyles.typography}>
				<p>
					...
					emulator's rom directory or SD card for your Everdrive X5) and give it
					the same name as the rom file. For emulators, your save file needs to
					have <code>.sav</code> as its extension, on an Everdrive, it needs to
					be <code>.fla</code>
				</p>
				<p className="bg-red-100 text-black p-4 -m-4">
					...
					<ul className="ml-12">
						<li>
							Press A on the <code>.fla</code> file and choose "Copy File to
							SRAM"
						</li>
						<li>
				...
				<p>
					...
					The save file should work on other flash carts, but I don't own any so
					I can't verify.
				</p>
				<h2>Once in game</h2>
